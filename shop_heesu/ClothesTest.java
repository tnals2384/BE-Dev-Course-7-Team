...
import day0724.QuantityException;

import java.util.Scanner;

public class ClothesTest {
        public static void main(String[] args) {
            ClothesService clothingManager = new ClothesService();
                ...
                switch (choice) {
                    ...
                    case 6:
                        ...
                        int sellQuantity = scanner.nextInt();
                            Stock stock1 = new Stock(sellId, sellSize, sellQuantity);
                            clothingManager.sell(stock1);
